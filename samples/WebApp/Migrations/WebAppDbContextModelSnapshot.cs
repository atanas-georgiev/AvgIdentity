namespace WebApp.Migrations
{
    ...
    partial class WebAppDbContextModelSnapshot : ModelSnapshot
    {
        ...
        {
            modelBuilder.HasAnnotation("ProductVersion", "1.1.0-rtm-22752")
                .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

            modelBuilder.Entity(
                "AvgIdentity.Models.AvgIdentityUser",
                b =>
                    {
                        ...
                        b.Property<string>("PasswordQuestion").HasMaxLength(100);
            ...
            modelBuilder.Entity(
                ...
                b =>
                    {
                        b.HasOne("AvgIdentity.Models.AvgIdentityUser")
                            .WithMany("Claims")
